...
library(readr)
                  ...
                  ###### Insert raw csv file for species data (found as a csv in the Github repository) #####
...
fhabitat <- read.csv("~/Desktop/Literature review chapter/Flies and flower shapes/fhabitat.csv")
View(fhabitat)
...
## Insert raw csv file for family data WITHOUT LABORATORY HABITAT
library(gridGraphics)
library(bipartite)
